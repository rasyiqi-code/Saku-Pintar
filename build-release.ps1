# Script Build RELEASE APK SakuPintar
# Otomatis load API Key, Build Web, Sync Capacitor, dan Build Android RELEASE APK

$ErrorActionPreference = "Stop"

Write-Host "🚀 Memulai proses Build RELEASE APK..." -ForegroundColor Cyan
...
Write-Host "Building RELEASE APK (Gradle)..." -ForegroundColor Yellow
...
Write-Host "`nBUILD RELEASE SUKSES!" -ForegroundColor Green
